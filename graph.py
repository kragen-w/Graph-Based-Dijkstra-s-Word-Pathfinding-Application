...
def Dijkstra(start,end,dict,huer):
    ...
    while len(Q) > 0:
        ...
        if end in S:
            ...
            print(f"The path is: {final_printable}")
            print(f"The path takes {count} word changes. ")
            print(node_searched)
            return ""
...
while cont:
    ...
    # print((Dijkstra(word1,word2,all, 2.39)))
    print((Dijkstra(word1,word2,all, 2.39)))
    print((Dijkstra(word1,word2,all, 1)))
    print((Dijkstra(word1,word2,all, 0)))
